...
mobility choice $\mu(R) = R/R_0$ from a deeper structural argument
on the substrate, rather than adopting it on the source-receiver
asymmetry rationale. Until that is done, the Schwarzschild-like
clock-rate factor of Eq~\eqref{eq:dtau_schw} should be read as a consequence of the bandwidth-throttled mobility, conditional on this specific mobility choice.
